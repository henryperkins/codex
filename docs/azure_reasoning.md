...
| `o4-mini` | [Model availability](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/concepts/models#global-standard-model-availability) | No access request needed to use the core capabilities of this model.      Request access: [o4-mini reasoning summary feature](https://aka.ms/oai/o3access) |
...
| `o1-mini` | [Model availability](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/concepts/models#global-standard-model-availability). | No access request needed for Global Standard deployments.      Standard (regional) deployments are currently only available to select customers who were previously granted access as part of the `o1-preview` release. |

- [GPT-5 Reasoning Models](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=gpt-5%2Cpython%2Cpy#tabpanel_1_gpt-5)
- [O-Series Reasoning Models](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=gpt-5%2Cpython%2Cpy#tabpanel_1_o-series)

| **Feature** | **gpt-5**, **2025-08-07** | **gpt-5-mini**, **2025-08-07** | **gpt-5-nano**, **2025-08-07** |
| --- | --- | --- | --- |
| **API Version** | [v1](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/api-version-lifecycle#api-evolution) | [v1](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/api-version-lifecycle#api-evolution) | [v1](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/api-version-lifecycle#api-evolution) |
| **[Developer Messages](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=gpt-5%2Cpython%2Cpy#developer-messages)** | ✅ | ✅ | ✅ |
| **[Structured Outputs](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/structured-outputs)** | ✅ | ✅ | ✅ |
| **[Context Window](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/concepts/models#o-series-models)** | 400,000      Input: 272,000   Output: 128,000 | 400,000      Input: 272,000   Output: 128,000 | 400,000      Input: 272,000   Output: 128,000 |
| **[Reasoning effort](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=gpt-5%2Cpython%2Cpy#reasoning-effort)** | ✅ | ✅ | ✅ |
...
| [Reasoning summary](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=gpt-5%2Cpython%2Cpy#reasoning-summary) | ✅ | ✅ | ✅ |
| Streaming | ✅ | ✅ | ✅ |

<sup>1</sup> Parallel tool calls are not supported when `reasoning_effort` is set to `minimal`  
  
<sup>2</sup> Reasoning models will only work with the `max_completion_tokens` parameter when using the Chat Completions API. Use `max_output_tokens` with the Responses API.  
...
| Feature | Description |
| --- | --- |
| `reasoning_effort` | `minimal` is now supported with GPT-5 series reasoning models      **Options**: `minimal`, `low`, `medium`, `high` |
| `verbosity` | A new parameter giving you more granular control over how concise the model's output will be.      **Options:**`low`, `medium`, `high`. |
| `preamble` | GPT-5 series reasoning models have the ability to spend extra time *"thinking"* before executing a function/tool call.      When this planning occurs the model can provide insight into the planning steps in the model response via a new object called the `preamble` object.      Generation of preambles in the model response is not guaranteed though you can encourage the model by using the `instructions` parameter and passing content like "You MUST plan extensively before each function call. ALWAYS output your plan to the user before calling any function" |
...
| [`lark_tool`](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=gpt-5%2Cpython%2Cpy#python-lark) | Allows you to use some of the capabilities of [Python lark](https://github.com/lark-parser/lark) for more flexible constraining of model responses |
...
These models [don't currently support the same set of parameters](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=gpt-5%2Cpython%2Cpy#api--feature-support) as other models that use the chat completions API.

- [Python (key-based auth)](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=gpt-5%2Cpython%2Cpy#tabpanel_2_python)
- [Python (Microsoft Entra ID)](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=gpt-5%2Cpython%2Cpy#tabpanel_2_python-secure)
- [C#](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=gpt-5%2Cpython%2Cpy#tabpanel_2_csharp)
...
- [Python (key-based auth)](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=gpt-5%2Cpython%2Cpy#tabpanel_3_python)
- [Python (Microsoft Entra ID)](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=gpt-5%2Cpython%2Cpy#tabpanel_3_python-secure)
- [C#](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=gpt-5%2Cpython%2Cpy#tabpanel_3_csharp)
...
When using the latest reasoning models with the [Responses API](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/responses) you can use the reasoning summary parameter to receive summaries of the model's chain of thought reasoning.

- [Python](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=gpt-5%2Cpython%2Cpy#tabpanel_4_py)
- [REST](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=gpt-5%2Cpython%2Cpy#tabpanel_4_REST)
