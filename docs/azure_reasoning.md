...
| --- | --- | --- |
| `gpt-5` | [Model availability](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/concepts/models#global-standard-model-availability) | Request access: [gpt-5 limited access model application](https://aka.ms/oai/gpt5access). If you already have `o3 access` no request is required |
| `gpt-5-mini` | [Model availability](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/concepts/models#global-standard-model-availability) | No access request needed. |
| `gpt-5-nano` | [Model availability](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/concepts/models#global-standard-model-availability) | No access request needed. |
