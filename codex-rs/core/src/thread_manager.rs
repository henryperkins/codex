...
impl ThreadManager {
    ...
    pub(crate) fn with_models_provider_and_home_for_tests(
        ...
        Self::with_models_provider_and_home_and_catalog_for_tests(auth, provider, codex_home, None)
    }

    pub(crate) fn with_models_provider_and_home_and_catalog_for_tests(
        auth: CodexAuth,
        provider: ModelProviderInfo,
        codex_home: PathBuf,
        model_catalog: Option<ModelsResponse>,
        ...
        Self {
            state: Arc::new(ThreadManagerState {
                threads: Arc::new(RwLock::new(HashMap::new())),
                thread_created_tx,
                models_manager: Arc::new(ModelsManager::with_provider_and_catalog_for_tests(
                    codex_home,
                    auth_manager.clone(),
                    provider,
                    model_catalog,
